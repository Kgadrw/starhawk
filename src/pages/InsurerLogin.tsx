    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Insurer Login</h1>
          <p className="text-gray-600">Access your insurance management dashboard</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500">
            ...
            <br />
            Contact admin at{" "}
            <a href="mailto:admin@cropinsurance.rw" className="text-blue-600 hover:text-blue-700">
